<template>
  <div class="route page">
    <div class="inner">
      ...
      <div class="headline">
        <h3><u>Lasted updated on August 1st, 2018</u></h3>
        <h1>Terms Of Service</h1>
      </div>


      <p>By using CitationGenerator (“Service”), you are agreeing to be bound by the following terms and conditions (“Terms of Service”).</p>

      <p>CitationGenerator (“Company”) reserves the right to update and change these Terms of Service without notice.</p>
      ...
      <p>Customers may access their Service data via the Application Program Interface (“API”). Any use of the API, including use of the API through a third-party product that accesses the Service, is bound by the terms of this agreement plus the following specific terms:</p>

      <ol>
        <li>You expressly understand and agree that the Company shall not be liable for any damages or losses resulting from your use of the API or third-party products that access data via the API.</li>
      ...
      <ol>
        ...
        <li>Prices of all Services are subject to change upon 30 days notice from us. Such notice may be provided at any time by posting the changes to the <a href="/">CitationGenerator site</a> or the Service itself.</li>
      ...
      <ol>
        ...
        <li>The look and feel of the Service is copyright © CitationGenerator. All rights reserved. You may not duplicate, copy, or reuse any portion of the HTML, CSS, JavaScript, or visual design elements without express written permission from the Company.</li>
      </ol>
      ...
      <ol>
        ...
        <li>Questions about the Terms of Service should be sent to <a href="mailto:hello@citationgenerator.com">hello@citationgenerator.com</a>.</li>
      </ol>
